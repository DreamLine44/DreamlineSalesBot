...
const orderSchema = new mongoose.Schema({
  ...
  // [AUDIT-FIX-PROMO-SCHEMA-1] See BusinessConfig.promotions / promoService.js.
  // promoCode is the normalized code actually applied (null if none/invalid);
  // discountAmount is the amount subtracted from the pre-discount subtotal to
  // reach totalPrice above, kept separately so the dashboard/receipt can show
  // "Subtotal − Discount = Total" rather than just the final number.
