/**
 * core/nlu/resolution/confirmationMatcher.js
 *
 ...
 *
 * Meanwhile core/nlu/classification/negationGuard.js already has a solid deterministic
...
import { analyzeMessage } from '../classification/negationGuard.js';
...
export async function resolveConfirmation({
  ...
  try {
    const { classifyIntent } = await import('../extraction/groqProvider.js');
