 ...
 * Cosmetics module â€” products + skin profile + AI beauty recommendations + consultations
 */
...
export const COSMETICS_CONFIG = {
  ...
  ui: {
    welcomeButtons: [
      ...
      { id: 'QUESTION', title: 'â“ Beauty Advice'     },
    ],
    fallbackButtons: [
      { id: 'ORDER',    title: 'ðŸ’„ Shop'    },
      { id: 'BOOK',     title: 'ðŸ’… Consult' },
      { id: 'QUESTION', title: 'â“ Advice'  },
    ],
  ...
  messages: {
    welcome:   'ðŸ’„ Welcome! Ready to glow? What can I help you find today?',
    cancelMsg: 'âœ… Cancelled! Come back anytime â€” we love helping you glow ðŸ’„',
    fallback:  'Would you like to *shop*, *book a consultation*, or get *beauty advice*?',
  },
};

// â”€â”€ Dedicated cosmetics order flow â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
/** Skincare advice flow â€” AI-powered with skin type context */
export async function handleSkincareAdvice({ session, message, business, tenant }) {
  ...
  if (message === null) {
    ...
    // [UX-COSM-3] 4 skin-type options â†’ WhatsApp list so all 4 show cleanly.
    return {
      type: 'list',
      body: 'ðŸ’„ *Beauty Advice*\n\nWhat would you like help with today?',
      ...
      sections: [{ title: 'Skin Type', rows: [
        ...
        { id: 'SKIN_COMBO',  title: 'ðŸŒŸ Combination',  description: 'Oily T-zone, dry cheeks'           },
        { id: 'SKIN_CUSTOM', title: 'ðŸ’¬ Describe it',  description: 'Type your specific skin concern'   },
      ]}],
    };
  }

  // â”€â”€ SKIN_QUESTION: customer picked a skin type button or typed their issue â”€
  if (step === 'SKIN_QUESTION') {
    ...
    if (mappedSkinType) {
      ...
      // have to type â€” most concerns map to one of these 5 options.
      return {
        type: 'list',
        body: `Got it â€” *${skinType} skin* ðŸ’„\n\nWhat's your main concern?`,
        button: 'Choose concern',
        sections: [{ title: 'Common Concerns', rows: [
          { id: 'CONCERN_ACNE',  title: 'ðŸ”´ Acne / Breakouts',    description: 'Spots, pimples, oiliness'       },
          { id: 'CONCERN_DARK',  title: 'ðŸŒ‘ Dark Spots / Uneven', description: 'Pigmentation, tone'              },
          { id: 'CONCERN_MOIST', title: 'ðŸ’§ Moisture / Dryness',  description: 'Hydration, flakiness'            },
          { id: 'CONCERN_AGE',   title: 'âœ¨ Anti-Ageing',          description: 'Fine lines, firmness'            },
          { id: 'CONCERN_SENSE', title: 'ðŸŒ¿ Sensitive Skin',       description: 'Redness, irritation, reactions'  },
        ]}],
        footer: 'Or type your specific concern',
      };
    }
    // They typed a description â€” treat it as their question immediately
    return await _buildSkincareAdvice(raw, skinType, business, session);
  }

  // â”€â”€ SKIN_ADVICE: they described their concern â€” answer it â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async function _buildSkincareAdvice(question, skinType, business, session) {
  ...
  // [FIX-COSM-CF] completeFlow was imported but never called â€” the SKINCARE_ADVICE
  // flow stayed active in session after advice was delivered. On the customer's next
  // tap ('ðŸ’„ Shop Now', 'â“ Another Question', 'ðŸ”„ Start Over') the session still had
  ...
  return {
    type: 'buttons',
    body: aiReply || 'Great question! Let me suggest some products for you. ðŸ’„',
    buttons: [
      { id: 'ORDER',     title: 'ðŸ’„ Shop Now'         },
      { id: 'QUESTION',  title: 'â“ Another Question'  },
